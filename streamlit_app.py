...
def main():
    ...
    with st.expander("📋 전략 로직 자세히 보기", expanded=False):
        ...
        with col1:
            ...
            <font color='black'>- <font color='black'>**Drawdown(3M)**: 고점 대비 하락률로 최근 3개월 고점 기준 하락폭이 클수록 저평가 판단
            ...
            <font color='black'>- <font color='black'>Drawdown 기준 Threshold 이하 하락 종목에 Weight Split% 배분 | 나머지 종목에 (1-Weight Split)% 배분
